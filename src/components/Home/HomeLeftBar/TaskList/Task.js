  ...
  return (
    <div class="lws-task">
      <div class="flex items-center gap-2 text-slate">
        <h2 class="lws-date">{day}</h2>
        <h4 class="lws-month">{month}</h4>
      </div>

      <div class="lws-taskContainer ">
        <h1 class="lws-task-title">{task.taskName}</h1>
        <span class={`lws-task-badge ${task.project.colorClass}`}>{task.project.projectName}</span>
      </div>

      <div class="flex items-center gap-4">
        <div class="flex items-center gap-2">
          <img src={ferdews} class="team-avater" alt="fer" />
